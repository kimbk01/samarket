/** 주소·지도 UI 핀 색 — signature green */
export const ADDRESS_MAP_PIN_FILL = "#00704A";

/** Maps PinElement 테두리·대비용 (fill 보다 한 단계 진한 톤) */
export const ADDRESS_MAP_PIN_BORDER = "#005C3C";

/** Tailwind `text-[…]` — `AddressKindHeadPin` 등 teardrop SVG */
export const ADDRESS_MAP_PIN_TEXT_CLASS = "text-[#00704A]" as const;
