...
export const POINT_CHARGE_REQUEST_ROW_SELECT =
  "id, user_id, plan_id, plan_name, payment_method, payment_amount, point_amount, applied_rate, rate_version, request_status, depositor_name, receipt_image_url, requested_at, updated_at, admin_memo, user_memo, approved_at, approved_by, processed_at, processed_by";
