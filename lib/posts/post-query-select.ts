...
export const POST_TRADE_CHAT_ABSOLUTE_MIN_SELECT =
  "id, user_id, title, price, is_price_offer, status, seller_listing_state, thumbnail_url, images, meta, region, city, created_at, updated_at, trade_category_id, reserved_buyer_id, content, sold_buyer_id";

/** 극단적 스키마 축소 시 — 카드·지역 라벨 일부만 희생하고 행 존재 여부 확보 */
export const POST_TRADE_CHAT_BARE_MIN_SELECT =
  "id, user_id, title, thumbnail_url, images, price, is_price_offer, status, seller_listing_state, reserved_buyer_id, sold_buyer_id, meta, created_at, updated_at, region, city";
