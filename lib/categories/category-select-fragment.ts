 ...
 */
/** `name_en` 마이그레이션 전 DB — 거래 탭·목록이 비지 않도록 레거시 SELECT 로 폴백 */
...
export const CATEGORY_WITH_SETTINGS_SELECT =
  "id, name, name_en, slug, icon_key, type, parent_id, sort_order, is_active, description, quick_create_enabled, quick_create_group, quick_create_order, show_in_home_chips, created_at, updated_at, category_settings(can_write, has_price, has_chat, has_location, has_direct_deal, has_free_share, post_type)";
