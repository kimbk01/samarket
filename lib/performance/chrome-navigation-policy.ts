...
export const BOTTOM_NAV_PREFETCH_PATH_DEBOUNCE_MS = 180;

/** `requestIdleCallback` 스케줄 지연 — 페인트·현재 세그먼트 페치 우선(메신저 등 탭 선로딩이 너무 늦지 않게 상한 완화) */
export const BOTTOM_NAV_PREFETCH_IDLE_DELAY_MS = 120;
