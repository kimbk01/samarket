...
export const storeCommerceUiMessages = {
  ...
  ko: {
    ...
    store_biz_patch_err_points_insufficient:
      "매장 포인트가 부족해 주문을 수락할 수 없습니다. 포인트 충전 후 다시 시도해 주세요.",
    ...
    store_owner_point_title: "매장 포인트",
    store_owner_point_balance_label: "보유 포인트",
    store_owner_point_blocked_badge: "주문 차단",
    store_owner_point_blocked_message:
      "포인트가 부족해 지금은 새 주문을 받을 수 없습니다. 고객 화면에는 준비중으로 표시됩니다.",
    store_owner_point_charge_cta: "포인트 충전 신청",
    store_owner_point_account_cta: "입금 계좌 문의",
    store_owner_point_section_account: "입금 계좌 문의",
    store_owner_point_section_charge: "포인트 충전 신청",
    store_owner_point_balance_current: "현재 보유 포인트",
    store_owner_point_charge_ratio_hint: "충전 포인트와 입금 금액은 1:1로 적용됩니다.",
    store_owner_point_inquiry_cta: "관리자 문의",
    store_owner_point_ledger_title: "최근 내역",
    store_owner_point_ledger_empty: "포인트 내역이 없습니다.",
    store_owner_point_estimated_orders: "예상 수락 가능",
    store_owner_point_estimated_orders_unit: "약 {count}건",
    store_owner_point_charge_title: "포인트 충전",
    store_owner_point_charge_amount: "충전 포인트",
    ...
    store_owner_point_err_platform_unavailable: "포인트 기능을 준비 중입니다. 잠시 후 다시 시도해 주세요.",
    store_owner_point_err_point_amount_required: "충전 포인트를 1 이상 입력해 주세요.",
  ...
  en: {
    ...
    store_biz_patch_err_points_insufficient:
      "Insufficient store points to accept this order. Please top up and try again.",
    store_biz_refund_requested_owner_notice:
    ...
    store_owner_point_title: "Store points",
    store_owner_point_balance_label: "Balance",
    store_owner_point_blocked_badge: "Orders blocked",
    store_owner_point_blocked_message:
      "Points are too low to accept new orders. Customers will see your store as preparing.",
    store_owner_point_charge_cta: "Request top-up",
    store_owner_point_account_cta: "Deposit account inquiry",
    store_owner_point_section_account: "Deposit account inquiry",
    store_owner_point_section_charge: "Point top-up request",
    store_owner_point_balance_current: "Current balance",
    store_owner_point_charge_ratio_hint: "Top-up points and payment amount are 1:1 for now.",
    store_owner_point_inquiry_cta: "Contact admin",
    store_owner_point_ledger_title: "Recent activity",
    store_owner_point_ledger_empty: "No point history yet.",
    store_owner_point_estimated_orders: "Est. orders you can accept",
    store_owner_point_estimated_orders_unit: "About {count}",
    store_owner_point_charge_title: "Top up points",
    store_owner_point_charge_amount: "Points to add",
    ...
    store_owner_point_err_platform_unavailable: "Point features are being set up. Please try again later.",
    store_owner_point_err_point_amount_required: "Enter at least 1 point to top up.",
