...
export const storeCommerceUiMessages = {
  ...
  ko: {
    ...
    store_delivery_distance_out_of_range: "배달 가능 지역 아님",
    /** Secondary numeric hint only — primary list/detail OOR uses `store_delivery_distance_out_of_range`. */
    store_delivery_distance_out_of_range_with_max: "배달 가능 지역 아님",
    ...
    store_owner_point_title: "이전 매장 운영 원장",
    store_owner_point_balance_label: "과거 원장 기록값",
    store_owner_point_not_ad_cash:
      "읽기 전용 과거 기록이며 현재 결제 수단이 아닙니다.",
    store_owner_point_blocked_badge: "과거 기록",
    store_owner_point_blocked_message:
      "이전 매장 운영 원장의 읽기 전용 보관 기록입니다.",
    store_owner_point_charge_cta: "과거 기록 보기",
    store_owner_point_account_cta: "과거 안내 보기",
    store_owner_point_section_account: "과거 안내",
    store_owner_point_section_charge: "과거 운영 기록",
    store_owner_point_balance_current: "과거 원장 기록값",
    store_owner_point_charge_ratio_hint: "이 값은 이전 매장 운영 원장의 보관 기록입니다.",
    store_owner_point_inquiry_cta: "기록 문의",
    store_owner_point_ledger_title: "과거 원장 내역",
    store_owner_point_ledger_empty: "과거 운영 기록이 없습니다.",
    store_owner_point_estimated_orders: "과거 기준값",
    store_owner_point_estimated_orders_unit: "{count}건 기록",
    store_owner_point_charge_title: "과거 운영 기록",
    store_owner_point_charge_amount: "기록값",
    store_owner_point_charge_payment: "당시 기록 금액 (PHP)",
    store_owner_point_charge_depositor: "기록 명의",
    store_owner_point_charge_bank: "기록 기관",
    store_owner_point_charge_receipt: "보관 자료 URL",
    store_owner_point_charge_memo: "보관 메모",
    store_owner_point_charge_submit: "기록 확인",
    store_owner_point_charge_pending: "보관 기록",
    store_owner_point_charge_on_hold: "읽기 전용 과거 운영 기록입니다.",
    store_owner_point_entry_store_order_fee: "과거 주문 기록",
    store_owner_point_entry_store_charge: "과거 운영 기록",
    store_owner_point_entry_admin_adjust: "과거 관리 기록",
    store_owner_point_step_account: "1. 과거 안내 기록",
    store_owner_point_step_awaiting: "2. 과거 처리 기록",
    store_owner_point_step_deposit: "3. 과거 보관 기록",
    store_owner_point_step_charge_pending: "과거 처리 기록",
    store_owner_point_account_inquiry_intro:
      "이전 매장 운영 안내를 읽기 전용 기록으로 제공합니다.",
    store_owner_point_account_inquiry_submit: "과거 안내 확인",
    store_owner_point_account_inquiry_pending: "과거 안내 기록입니다.",
    store_owner_point_account_answer_title: "과거 운영 안내",
    store_owner_point_account_answer_hint: "보관된 관리자 안내입니다.",
    store_owner_point_account_inquiry_already_open: "과거 안내 기록이 있습니다.",
    store_owner_point_deposit_blocked_hint: "현재 운영 상품이 아닌 보관 기록입니다.",
    store_owner_point_charge_history_title: "과거 운영 기록",
    store_owner_point_charge_history_empty: "과거 운영 기록이 없습니다.",
    store_owner_point_charge_status_pending: "보관됨",
    store_owner_point_charge_status_waiting: "보관됨",
    store_owner_point_charge_status_approved: "보관됨",
    store_owner_point_charge_status_rejected: "보관됨",
    store_owner_point_charge_status_hold: "보관됨",
    store_owner_point_inquiry_status_open: "보관됨",
    store_owner_point_inquiry_status_answered: "보관됨",
    store_owner_point_inquiry_status_closed: "보관됨",
    store_owner_point_err_account_inquiry_required: "과거 운영 기록을 확인해 주세요.",
    store_owner_point_err_account_inquiry_not_answered: "과거 관리자 안내 기록입니다.",
    store_owner_point_err_charge_already_pending: "과거 처리 기록이 있습니다.",
    store_owner_point_err_account_inquiry_already_open: "과거 안내 기록이 있습니다.",
    store_owner_point_err_platform_unavailable: "이전 매장 운영 원장은 읽기 전용입니다.",
    store_owner_point_err_point_amount_required: "과거 기록값을 확인해 주세요.",
    store_owner_point_err_depositor_name_required: "과거 기록 명의를 확인해 주세요.",
    store_owner_point_err_subject_required: "기록 제목과 내용을 확인해 주세요.",
    store_owner_point_dashboard_awaiting_account: "과거 안내 기록입니다.",
    store_owner_point_dashboard_charge_pending: "과거 처리 기록입니다.",
    ...
    store_owner_dash_today_summary: "오늘 생성·매출 요약",
    ...
    store_owner_dash_urgent_title: "지금 처리할 주문",
    store_owner_dash_new_orders: "미수락 대기",
    ...
    store_owner_dash_unconfirmed_orders: "3분+ 미수락",
    ...
    store_owner_dash_today_order_count: "오늘 생성",
    store_owner_dash_today_order_hint: "오늘 생성된 주문 수 · 과거 미수락 큐는 위 긴급 처리에 표시",
  ...
  en: {
    ...
    store_delivery_distance_out_of_range: "Outside delivery area",
    /** Secondary numeric hint only — primary list/detail OOR uses `store_delivery_distance_out_of_range`. */
    store_delivery_distance_out_of_range_with_max: "Outside delivery area",
    ...
    store_biz_patch_err_points_insufficient:
      "This is linked to a historical store operations ledger record.",
    store_biz_refund_requested_owner_notice:
    ...
    store_owner_point_title: "Historical store operations ledger",
    store_owner_point_balance_label: "Historical recorded value",
    store_owner_point_not_ad_cash:
      "Read-only historical record; not a current payment method.",
    store_owner_point_blocked_badge: "Historical record",
    store_owner_point_blocked_message:
      "Read-only archived entry from the historical store operations ledger.",
    store_owner_point_charge_cta: "View historical records",
    store_owner_point_account_cta: "View historical notice",
    store_owner_point_section_account: "Historical notice",
    store_owner_point_section_charge: "Historical operations record",
    store_owner_point_balance_current: "Historical recorded value",
    store_owner_point_charge_ratio_hint: "This value is archived from the previous store operations ledger.",
    store_owner_point_inquiry_cta: "Ask about record",
    store_owner_point_ledger_title: "Historical ledger entries",
    store_owner_point_ledger_empty: "No historical operations records.",
    store_owner_point_estimated_orders: "Historical reference count",
    store_owner_point_estimated_orders_unit: "{count} recorded",
    store_owner_point_charge_title: "Historical operations record",
    store_owner_point_charge_amount: "Recorded value",
    store_owner_point_charge_payment: "Recorded amount at the time (PHP)",
    store_owner_point_charge_depositor: "Recorded name",
    store_owner_point_charge_bank: "Recorded institution",
    store_owner_point_charge_receipt: "Archived document URL",
    store_owner_point_charge_memo: "Archive memo",
    store_owner_point_charge_submit: "Review record",
    store_owner_point_charge_pending: "Archived record",
    store_owner_point_charge_on_hold:
      "This is a read-only historical operations record.",
    store_owner_point_entry_store_order_fee: "Historical order record",
    store_owner_point_entry_store_charge: "Historical operations record",
    store_owner_point_entry_admin_adjust: "Historical admin record",
    store_owner_point_step_account: "1. Historical notice",
    store_owner_point_step_awaiting: "2. Historical processing record",
    store_owner_point_step_deposit: "3. Historical archived record",
    store_owner_point_step_charge_pending: "Historical processing record",
    store_owner_point_account_inquiry_intro:
      "Previous store operations notices are available as read-only records.",
    store_owner_point_account_inquiry_submit: "Review historical notice",
    store_owner_point_account_inquiry_pending: "This is a historical notice record.",
    store_owner_point_account_answer_title: "Historical operations notice",
    store_owner_point_account_answer_hint: "Archived admin guidance.",
    store_owner_point_account_inquiry_already_open: "A historical notice record exists.",
    store_owner_point_deposit_blocked_hint: "This is an archived record, not a current operations product.",
    store_owner_point_charge_history_title: "Historical operations records",
    store_owner_point_charge_history_empty: "No historical operations records.",
    store_owner_point_charge_status_pending: "Archived",
    store_owner_point_charge_status_waiting: "Archived",
    store_owner_point_charge_status_approved: "Archived",
    store_owner_point_charge_status_rejected: "Archived",
    store_owner_point_charge_status_hold: "Archived",
    store_owner_point_inquiry_status_open: "Archived",
    store_owner_point_inquiry_status_answered: "Archived",
    store_owner_point_inquiry_status_closed: "Archived",
    store_owner_point_err_account_inquiry_required: "Review the historical operations record.",
    store_owner_point_err_account_inquiry_not_answered: "This is a historical admin notice.",
    store_owner_point_err_charge_already_pending: "A historical processing record exists.",
    store_owner_point_err_account_inquiry_already_open: "A historical notice record exists.",
    store_owner_point_err_platform_unavailable: "The historical store operations ledger is read-only.",
    store_owner_point_err_point_amount_required: "Review the historical recorded value.",
    store_owner_point_err_depositor_name_required: "Review the historical recorded name.",
    store_owner_point_err_subject_required: "Review the record subject and message.",
    store_owner_point_dashboard_awaiting_account: "Historical notice record.",
    store_owner_point_dashboard_charge_pending: "Historical processing record.",
    ...
    store_owner_dash_today_summary: "Created today · sales",
    ...
    store_owner_dash_urgent_title: "Orders to handle now",
    store_owner_dash_new_orders: "Awaiting accept",
    ...
    store_owner_dash_unconfirmed_orders: "Pending 3m+",
    ...
    store_owner_dash_today_order_count: "Created today",
    store_owner_dash_today_order_hint: "Orders created today · older pending queue is in Action required above",
