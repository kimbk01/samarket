...
export const storeCommerceUiMessages = {
  ...
  ko: {
    ...
    store_owner_point_account_inquiry_intro:
      "충전을 위해 입금 계좌 안내가 필요합니다. 아래 버튼으로 문의를 보내 주세요.",
    ...
    store_owner_point_account_answer_hint: "아래 계좌로 입금한 뒤 충전 신청을 진행해 주세요.",
  ...
  en: {
    ...
    store_owner_point_account_inquiry_intro:
      "Request a deposit account before you can top up. Tap the button below.",
    ...
    store_owner_point_account_answer_hint: "Transfer to the account below, then submit your top-up request.",
