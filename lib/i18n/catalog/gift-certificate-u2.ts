...
export const giftCertificateU2Messages = {
  ko: {
    ...
    gift_u2_card_scope_store_short: "{store}에서 사용 가능",
    gift_u2_detail_sales_window: "판매기간 {range}",
  ...
  en: {
    ...
    gift_u2_card_scope_store_short: "Usable at {store}",
    gift_u2_detail_sales_window: "Sales period {range}",
    gift_u2_card_digital_value: "DIGITAL VALUE",
