...
export const TRADE_PRIMARY_TABS_EMBED_SCROLL_SHELL_CLASS =
  "relative flex flex-shrink-0 items-center gap-1 overflow-x-auto bg-gray-100 scrollbar-none [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden";

export const TRADE_PRIMARY_TABS_STICKY_FALLBACK_SHELL_CLASS =
  "sticky top-14 z-10 flex flex-shrink-0 items-center gap-1 overflow-x-auto border-b border-gray-200 bg-gray-100 py-2 scrollbar-none [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden";
