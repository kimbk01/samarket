 ...
 *
 * Android APK: OS ring — FCM {@link IncomingCallRingOwner} + Realtime {@link startNativeIncomingRingtoneFireAndForget}.
...
import { stopNativeIncomingRingtoneFireAndForget, startNativeIncomingRingtoneFireAndForget } from "@/lib/push/native/dibay-call-consumed-native-bridge";
...
export function syncIncomingCallRing(candidate: IncomingRingSyncCandidate | null): void {
  ...
  if (useNativeRingOwner()) {
    startNativeIncomingRingtoneFireAndForget(sid, candidate.callKind);
