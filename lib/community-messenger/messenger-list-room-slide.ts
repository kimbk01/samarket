...
export const MESSENGER_LIST_ROOM_ENTER_MS = 180;
export const MESSENGER_LIST_ROOM_EXIT_MS = 150;
...
export const MESSENGER_PILLAR_LIST_ENTER_MS = 320;
export const MESSENGER_PILLAR_LIST_EXIT_MS = 280;
