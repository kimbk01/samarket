 ...
 * - `roomManaged` — 열린 채팅방·멤버 시트 등 (`CommunityMessengerRoomClient` → `bootstrapCommunityMessengerOutgoingCallAndNavigate`:
 *   `POST .../rooms/:id/calls` 후 곧바로 `/community-messenger/calls/:sessionId`. `/calls/outgoing` 은 딥링크·호환용.)
 *
