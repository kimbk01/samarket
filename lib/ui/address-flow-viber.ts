...
export const ADDR_ADD_CTA =
  "w-full rounded-ui-rect border border-sam-primary-border bg-sam-primary-soft/35 py-3.5 text-[15px] font-semibold text-signature shadow-sm transition-colors hover:bg-sam-primary-soft";

export const ADDR_ROW_TITLE = "text-[14px] font-semibold text-signature/95";
...
export const ADDR_SEARCH_INPUT =
  "min-w-0 flex-1 border-0 bg-transparent py-1.5 text-[15px] text-sam-fg outline-none placeholder:text-sam-meta";

export const ADDR_SECTION_LABEL =
  "mb-2 text-[12px] font-semibold uppercase tracking-wide text-signature/80";
...
export const ADDR_BODY_STRONG = "text-[14px] font-medium text-sam-fg";

export const ADDR_LIST_ROW_BTN =
  "min-w-0 flex-1 rounded-ui-rect border border-transparent px-2 py-3 text-left text-[14px] text-sam-fg hover:border-sam-primary-border/60 hover:bg-sam-primary-soft/35";

export const ADDR_BTN_PRIMARY_FULL =
  "w-full rounded-ui-rect bg-signature py-3.5 text-[15px] font-semibold text-white shadow-md transition-opacity hover:opacity-95 disabled:opacity-40";

export const ADDR_BTN_SECONDARY_FULL =
  "w-full rounded-ui-rect border border-sam-primary-border bg-white py-3.5 text-[15px] font-semibold text-signature shadow-sm transition-colors hover:bg-sam-primary-soft/50";

export const ADDR_BTN_TERTIARY_FULL =
  "text-[13px] font-medium text-sam-meta underline-offset-2 hover:text-signature hover:underline";
