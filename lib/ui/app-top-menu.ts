...
const APP_TOP_MENU_ROW1_CORE =
  "shrink-0 px-4 py-2 sam-text-body-secondary font-semibold transition";
...
export const APP_TOP_MENU_ROW2_BASE =
  "shrink-0 rounded-full px-3 py-1.5 sam-text-body-secondary font-semibold transition whitespace-nowrap";

export const APP_TOP_MENU_ROW2_INACTIVE_SKY = "bg-sky-50 text-sky-900 hover:bg-sky-100";

/**
 * 마켓 거래 리스트 1·2행 — 피드 카드 하단 메타(위치·시간)와 동일 톤(sam-text-helper #999), 배경 박스 없음
 */
export const APP_MARKET_MENU_TEXT_BASE =
  "shrink-0 whitespace-nowrap rounded-ui-rect px-2 py-1.5 sam-text-helper transition-colors";
