...
export const DELIVERY_AD_INVENTORY_SEEDS: readonly DeliveryAdInventorySeed[] = [
  ...
  },
  {
    ...
    isActive: true,
    notes:
      "Stage 2 — HOME composition slot homeBannerBeforeRest (before rest_stores). Content-column 2:1.",
  },
  {
    ...
    isActive: true,
    notes:
      "Stage 2 — Browse top_context Banner. Category policy bannerAds (separate from native adEnabled). Not SEARCH 3:1.",
  },
  {
    ...
    isActive: false,
    notes: "Stage 2 REJECTED_PHYSICAL_SLOT — no Admin-owned fixed every-N boundary yet",
  },
  {
