...
const ORDER_SELECT =
  "id, order_no, buyer_user_id, order_status, payment_status, payment_amount, gift_redemption_amount, discount_amount, store_funded_amount, platform_funded_amount, delivery_fee_amount, created_at, updated_at, refunded_at";
