...
const META_KIND_TO_EVENT_KEY: Readonly<Record<string, string>> = {
  ...
  store_order_accept_reminder_30s: "delivery_order_created_owner",
  store_order_accept_reminder_60s: "delivery_order_created_owner",
  store_order_payment_completed: "delivery_order_created_owner",
  store_order_buyer_cancelled: "delivery_order_created_owner",
