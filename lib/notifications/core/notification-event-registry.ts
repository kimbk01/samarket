...
export const NOTIFICATION_EVENT_DEFINITIONS = Object.freeze({
  ...
  inbox_message_received: define({
    type: "inbox_message_received",
    eventCategory: "inbox_message_received",
    productCategory: "system",
    domain: "admin",
    bellPolicy: "include",
    appIconPolicy: "exclude",
  ...
  support_customer_replied: define({
