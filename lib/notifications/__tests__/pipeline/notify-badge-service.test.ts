...
const SAMPLE_DOMAIN = {
  ...
  messengerUnreadRoomIds: { general_direct: ["gd1"], group: ["gr1"] },
  tradeUnreadRoomIds: ["tr1"],
  storeOrderUnreadRoomIds: { customer: [], owner: [] },
  explainMatrix: {
    authority: "domain_badge_explain_v1" as const,
    appIcon: {
      total: 3,
      general: { count: 1, roomIds: ["gd1"] },
      group: { count: 1, roomIds: ["gr1"] },
      trade: { count: 1, roomIds: ["tr1"] },
      customerOrder: { count: 0, roomIds: [] },
      ownerOrder: { count: 0, roomIds: [] },
      missedCall: { count: 0, eventIds: [] },
    },
    bottom: {
      total: 2,
      general: { count: 1, roomIds: ["gd1"] },
    ...
    trade: { count: 1, roomIds: ["tr1"] },
    customer: { count: 0, roomIds: [] },
    owner: { count: 0, roomIds: [], byStoreId: {} },
  },
