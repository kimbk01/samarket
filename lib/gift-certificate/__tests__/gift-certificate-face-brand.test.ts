...
describe("DIBAY gift certificate portrait face SSOT", () => {
  ...
  it("landmark zoning matches master geometry", () => {
    ...
    expect(GIFT_PORTRAIT_LANDMARKS.amountY).toBe(600);
    expect(GIFT_PORTRAIT_LANDMARKS.priceY).toBe(680);
    expect(GIFT_PORTRAIT_LANDMARKS.perforationY).toBe(735);
    expect(GIFT_PORTRAIT_LANDMARKS.issuerY).toBe(790);
    expect(GIFT_PORTRAIT_LANDMARKS.expiryY).toBe(845);
    expect(GIFT_PORTRAIT_LANDMARKS.numberY).toBe(900);
    expect(GIFT_PORTRAIT_LANDMARKS.serialY).toBe(960);
    expect(GIFT_PORTRAIT_LANDMARKS.giftableY).toBe(1060);
    expect(GIFT_PORTRAIT_LANDMARKS.heroBottomY / h).toBeCloseTo(330 / 1200, 5);
    expect(GIFT_PORTRAIT_LANDMARKS.perforationY / h).toBeCloseTo(735 / 1200, 5);
  });
