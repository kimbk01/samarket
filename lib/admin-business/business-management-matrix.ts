...
export const BUSINESS_MANAGEMENT_MATRIX: BusinessMgmtRow[] = [
  ...
  {
    domain: "주문취소",
    route: "/admin/stores/orders/cancellations",
    storeFilter: "NONE",
    filterParam: null,
    bccLinkableToday: false,
    status: "PARTIAL",
  ...
  {
    domain: "환불",
    route: "/admin/stores/orders/refunds",
    storeFilter: "NONE",
    filterParam: null,
    bccLinkableToday: false,
    status: "PARTIAL",
  ...
  {
    domain: "수수료",
    route: "/admin/store-fee-policies + BCC inline",
    storeFilter: "INLINE_BCC",
  ...
  {
    domain: "정산",
    route: "/admin/store-settlements",
    storeFilter: "API",
    filterParam: "store_id (UI state)",
    bccLinkableToday: false,
    status: "PARTIAL",
  },
  {
