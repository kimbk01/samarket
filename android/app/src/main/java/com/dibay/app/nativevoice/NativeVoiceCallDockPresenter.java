...
/** Activity-bound dock presentation for Native Voice CONNECTED UI. No Runtime ownership. */
public final class NativeVoiceCallDockPresenter {
  ...
  private NativeVoiceCallDockPresenter() {}

  public static Model build(Context context, NativeVoiceCallRuntime.Session session, String durationText) {
    ...
    String endLabel = safeString(app, R.string.dibay_voice_call_end);
  ...
  public static void bind(
    ...
    if (mediaIconView != null) {
      mediaIconView.setImageResource(android.R.drawable.sym_action_call);
