          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className={`inline-flex h-7 w-12 shrink-0 items-center rounded-full transition-colors ${
                settings.push_enabled !== false ? "bg-signature" : "bg-gray-200"
              }`}
            >
              <span
        ...
        <div className="border-b border-gray-100 px-4 py-3">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className={`inline-flex h-7 w-12 shrink-0 items-center rounded-full transition-colors ${
                settings.chat_push_enabled !== false ? "bg-signature" : "bg-gray-200"
              }`}
            >
              <span
                className={`inline-block h-6 w-6 rounded-full bg-white shadow transition-transform ${
        ...
        <div className="border-b border-gray-100 px-4 py-3">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className={`inline-flex h-7 w-12 shrink-0 items-center rounded-full transition-colors ${
                settings.marketing_push_enabled ? "bg-signature" : "bg-gray-200"
              }`}
            >
              <span
                className={`inline-block h-6 w-6 rounded-full bg-white shadow transition-transform ${
            ...
            <div className="flex items-center justify-between gap-3">
                ...
                <p className="mt-0.5 text-[12px] leading-snug text-gray-500">
                  ...
                  {commerceEmailColumnMissing ? (
                    <span className="mt-1 block text-amber-700">
                      ...
                      <code className="rounded bg-gray-100 px-0.5">manual-apply-notifications-full.sql</code> 을 적용해
                      주세요.
                    </span>
                  ) : null}
              ...
              <button
                ...
                className={`inline-flex h-7 w-12 shrink-0 items-center rounded-full transition-colors disabled:opacity-50 ${
                  commerceEmailOn ? "bg-signature" : "bg-gray-200"
                }`}
              >
                <span
                  className={`inline-block h-6 w-6 rounded-full bg-white shadow transition-transform ${
        ...
        <div className="space-y-3 px-4 py-3">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className={`inline-flex h-7 w-12 shrink-0 items-center rounded-full transition-colors ${
                settings.do_not_disturb_enabled ? "bg-signature" : "bg-gray-200"
              }`}
            >
              <span
                className={`inline-block h-6 w-6 rounded-full bg-white shadow transition-transform ${
