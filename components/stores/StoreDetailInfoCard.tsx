...
export function StoreDetailInfoCard({
  ...
  return (
    ...
    >
      ...
      <p className="mt-2 text-[20px] font-bold leading-tight tracking-tight text-stone-900">{storeName}</p>

      <div className="mt-4 grid grid-cols-2 gap-2 sm:grid-cols-4">
        <div className={STORE_DETAIL_METRIC_TILE}>
          <p className="text-[11px] font-medium text-stone-500">평점</p>
          <p className="mt-0.5 text-[17px] font-bold tabular-nums text-stone-900">★ {ratingDisplay}</p>
        </div>
        <button
          type="button"
          onClick={onReviewClick}
          className={`${STORE_DETAIL_METRIC_TILE} text-left transition-colors active:bg-stone-100`}
        >
          <p className="text-[11px] font-medium text-stone-500">리뷰</p>
        ...
        {onFavoriteClick ? (
          <button
            ...
            className={`${STORE_DETAIL_METRIC_TILE} text-left transition-colors active:bg-stone-100`}
          >
            <p className="text-[11px] font-medium text-stone-500">찜</p>
            <p className="mt-0.5 text-[17px] font-bold tabular-nums text-stone-900">
        ...
        <div className={STORE_DETAIL_METRIC_TILE}>
          <p className="text-[11px] font-medium text-stone-500">최근 주문</p>
          <p className="mt-0.5 text-[17px] font-bold tabular-nums text-stone-900">
