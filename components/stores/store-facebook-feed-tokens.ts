...
export const FB = {
  ...
  card: "rounded-ui-rect bg-sam-surface shadow-[0_1px_2px_rgba(0,0,0,0.06)] dark:bg-[#242526] dark:shadow-none dark:ring-1 dark:ring-sam-surface/[0.08]",
  cardFlat: "rounded-ui-rect bg-sam-surface dark:bg-[#242526] dark:ring-1 dark:ring-sam-surface/[0.08]",
  name: "text-[12px] font-semibold leading-snug text-[#050505] dark:text-[#E4E6EB]",
  body: "text-[12px] leading-snug text-[#050505] dark:text-[#E4E6EB]",
