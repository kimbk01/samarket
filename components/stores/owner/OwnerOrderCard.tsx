  ...
  return (
    <article className="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm">
      ...
      <div className="mt-3 flex flex-wrap items-center gap-2 text-sm">
        <span className={`rounded-md px-2 py-0.5 text-xs font-bold ${typeBadge.cls}`}>{typeBadge.text}</span>
      ...
      <div className="mt-3 flex gap-2">
        <Link
          href={detailHref}
          className="flex-1 rounded-xl bg-gray-100 py-2.5 text-center text-sm font-semibold text-gray-800"
        >
          상세보기
        </Link>
        <Link
