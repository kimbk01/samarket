...
export type StoresHomeFoodDiscoveryPresentation = "foodRail" | "highRating";

/** CUT3 — 가로 food discovery 레일 */
export function StoresHomeFoodDiscoveryRail({
  ...
  actionHref?: string;
  actionLabel?: string;
  presentation?: StoresHomeFoodDiscoveryPresentation;
}) {
