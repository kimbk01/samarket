...
export const TRADE_PRIMARY_APP_BAR_SHELL_CLASS =
  "sector-header-shell sector-header-shell--embedded";

/** Philife·플랫 커뮤니티 — 그림자 없음 */
export const TRADE_PRIMARY_APP_BAR_SHELL_FLAT_CLASS =
  "sector-header-shell sector-header-shell--embedded sector-header-shell--flat";
