    ...
    >
      <div className="w-full max-w-lg rounded-t-[length:var(--ui-radius-rect)] bg-sam-surface px-5 pb-10 pt-5 shadow-2xl">
        ...
        {paymentMethod === "manual_confirm" && (
          <div className="mb-4 space-y-2">
            <div className="rounded-ui-rect bg-amber-50 px-3 py-2.5 text-[12px] text-amber-800">
        ...
        <button
          ...
          className="w-full rounded-ui-rect bg-sky-600 py-3.5 text-[15px] font-bold text-white shadow-md disabled:opacity-40"
        >
