...
export function MeetingRoomHero({
  ...
  return (
    <div className="overflow-hidden rounded-3xl border border-gray-200/80 bg-white shadow-sm">
              ...
              {menuOpen ? (
                ...
                >
                  <button
                    type="button"
                    role="menuitem"
                    className="flex w-full items-center justify-between gap-2 px-4 py-2.5 text-left text-gray-900 hover:bg-gray-50"
                  ...
                  <button
                    type="button"
                    role="menuitem"
                    className="w-full px-4 py-2.5 text-left text-gray-900 hover:bg-gray-50"
      ...
      <div className="grid grid-cols-1 divide-y divide-gray-100 bg-white sm:grid-cols-1">
        <div className="flex flex-col items-center py-3.5">
          ...
          <span className="text-[11px] text-gray-500">멤버</span>
        </div>
      </div>
    </div>
  );
