      ...
      return (
        <div className="space-y-8 divide-y divide-gray-100">
          <div className="space-y-3 pt-1">
            <p className="text-[14px] font-semibold text-gray-900">채팅 설정</p>
            <ChatSettingsContent />
          </div>
          <div className="space-y-3 pt-6">
            <p className="text-[14px] font-semibold text-gray-900">알림 설정</p>
    ...
    <div className="space-y-4">
      <div className="rounded-ui-rect border border-gray-200 bg-white p-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-[12px] text-gray-500">배터리 매너</p>
            <p
              className={`text-[18px] font-bold tabular-nums ${
                mannerTier ? mannerBatteryAccentClass(mannerTier) : "text-gray-400"
              }`}
            >
