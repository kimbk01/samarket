...
export function PurchaseReviewSheet({
  ...
  return (
    ...
    >
      <div className="flex max-h-full min-h-0 w-full max-w-lg flex-col overflow-hidden rounded-t-2xl bg-white shadow-xl sm:max-h-[min(90vh,calc(100dvh-4rem-env(safe-area-inset-bottom,0px)))] sm:rounded-2xl">
