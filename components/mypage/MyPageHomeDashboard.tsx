      ...
      <section className={`${APP_MAIN_GUTTER_X_CLASS} pt-4`}>
        <div className="flex items-start gap-3 rounded-[4px] border border-gray-200 bg-white p-4">
          ...
          <div className="min-w-0 flex-1">
            ...
            <Link
              href={MYPAGE_PROFILE_EDIT_HREF}
              className="mt-3 inline-flex h-9 items-center justify-center rounded-[4px] border border-gray-200 px-3 text-[14px] font-medium text-gray-800 hover:bg-gray-50"
            >
              프로필 수정
            </Link>
          </div>
