          ...
          {!preferMobileImageSheet && attachOpen ? (
            ...
            >
              <button
                type="button"
                role="menuitem"
                className={`flex w-full items-center gap-2 px-3 py-2.5 text-left sam-text-body font-medium ${ig ? "text-foreground hover:bg-black/[0.04]" : "text-sam-fg hover:bg-sam-app"}`}
                onClick={() => {
                  setAttachOpen(false);
