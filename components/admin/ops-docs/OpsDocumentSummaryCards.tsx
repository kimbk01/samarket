  ...
  return (
    <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
      <div className="rounded-ui-rect border border-sam-border bg-sam-surface p-4">
        <p className="sam-text-helper text-sam-muted">전체 문서</p>
        <p className="sam-text-page-title font-semibold text-sam-fg">
          {summary.totalDocuments}
        </p>
      </div>
      <div className="rounded-ui-rect border border-sam-border bg-sam-surface p-4">
        <p className="sam-text-helper text-sam-muted">활성 / 초안 / 보관</p>
        <p className="sam-text-page-title font-semibold text-sam-fg">
          {summary.totalActive} / {summary.totalDraft} / {summary.totalArchived}
        </p>
      </div>
      <div className="rounded-ui-rect border border-sam-border bg-sam-surface p-4">
        <p className="sam-text-helper text-sam-muted">고정 문서</p>
        <p className="sam-text-page-title font-semibold text-sam-fg">
          {summary.totalPinned}
        </p>
