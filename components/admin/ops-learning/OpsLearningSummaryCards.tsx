  ...
  return (
    <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
      <div className="rounded-ui-rect border border-sam-border bg-sam-surface p-4">
        <p className="sam-text-helper text-sam-muted">패턴 / 미해결 / 완화</p>
      ...
      <div className="rounded-ui-rect border border-sam-border bg-sam-surface p-4">
        <p className="sam-text-helper text-sam-muted">평균 대응 품질 / 해결 속도</p>
        <p className="sam-text-page-title font-semibold text-sam-fg">
          {(summary.avgResponseQualityScore * 100).toFixed(0)}% / {(summary.avgResolutionSpeedScore * 100).toFixed(0)}%
        </p>
      </div>
      <div className="rounded-ui-rect border border-sam-border bg-sam-surface p-4">
        <p className="sam-text-helper text-sam-muted">고재발 패턴 / 최근 탐지</p>
        <p className="sam-text-page-title font-semibold text-sam-fg">
