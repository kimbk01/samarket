...
const ADMIN_MENU_TITLE_KEY_BY_ITEM_KEY: Partial<Record<string, MessageKey>> = {
  ...
  "trade-post-ads": "admin_menu_ads_posts",
  "trade-ad-policies": "admin_menu_ads_policy",
  ...
  "settings-auth": "admin_menu_settings_general",
...
export const adminMenu: AdminMenuItem[] = attachAdminMenuTitleKeys([
    ...
    children: [
      ...
      { key: "menu-main-bottom-nav", title: "메인 하단 탭", path: "/admin/menus/main-bottom-nav", status: "done" },
      {
        ...
        children: [
          ...
          { key: "trade-post-ads", title: "거래 광고 신청", path: "/admin/trade-post-ads", status: "done" },
          { key: "trade-ad-policies", title: "거래 광고 정책", path: "/admin/trade-ad-policies", status: "done" },
  ...
  },
  {
    ...
    children: [
      ...
      { key: "settings-auth", title: "Auth 로그인 설정", path: "/admin/settings/auth", status: "done" },
