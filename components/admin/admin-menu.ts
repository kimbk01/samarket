...
export const adminMenu: AdminMenuItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { key: "regions", title: "지역관리", path: "/admin/regions", pendingRoute: true, status: "todo" },
      {
        ...
        path: "/admin/menus",
        children: [
          { key: "menu-trade", title: "메뉴 (중고·거래)", path: "/admin/menus/trade", status: "done" },
          { key: "menu-community", title: "메뉴 (동네생활)", path: "/admin/menus/community", status: "done" },
      ...
      },
      {
        ...
        children: [
          ...
          { key: "community-sections", title: "피드 섹션", path: "/admin/community/sections", status: "done" },
          { key: "community-topics", title: "피드 주제", path: "/admin/community/topics", status: "done" },
          {
          ...
          { key: "community-feed-reports", title: "피드 신고", path: "/admin/community/reports", status: "done" },
      ...
      },
      {
        ...
        children: [
          ...
          { key: "chat-community", title: "커뮤니티", path: "/admin/chats/community", status: "done" },
  ...
  },
  {
    ...
    title: "광고/노출",
    children: [
      { key: "ads-applications", title: "광고신청", path: "/admin/ad-applications", status: "done" },
