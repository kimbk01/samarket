  ...
  return (
    <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
      <div className="rounded-ui-rect border border-sam-border bg-sam-surface p-4">
        <p className="text-[12px] text-sam-muted">점검 항목</p>
        <p className="text-[20px] font-semibold text-sam-fg">
          {summary.totalChecks}건
        </p>
      </div>
      <div className="rounded-ui-rect border border-sam-border bg-sam-surface p-4">
        <p className="text-[12px] text-sam-muted">안전 / 주의 / 위험</p>
      ...
      <div className="rounded-ui-rect border border-sam-border bg-sam-surface p-4">
        <p className="text-[12px] text-sam-muted">미해결 이슈</p>
        <p className="text-[20px] font-semibold text-sam-fg">
          {summary.openIssues}건
        </p>
      </div>
      <div className="rounded-ui-rect border border-sam-border bg-sam-surface p-4">
        <p className="text-[12px] text-sam-muted">critical 이슈</p>
        <p
