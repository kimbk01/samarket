  ...
  return (
    <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
      <div className="rounded-ui-rect border border-sam-border bg-sam-surface p-4">
        <p className="sam-text-helper text-sam-muted">총 실행</p>
        <p className="sam-text-page-title font-semibold text-sam-fg">
          {summary.totalExecutions}
        </p>
      </div>
      <div className="rounded-ui-rect border border-sam-border bg-sam-surface p-4">
        <p className="sam-text-helper text-sam-muted">진행 중 / 완료 / 대기</p>
        <p className="sam-text-page-title font-semibold text-sam-fg">
          {summary.inProgressExecutions} / {summary.completedExecutions} / {summary.blockedExecutions}
        </p>
      </div>
      <div className="rounded-ui-rect border border-sam-border bg-sam-surface p-4">
        <p className="sam-text-helper text-sam-muted">평균 소요</p>
        <p className="sam-text-page-title font-semibold text-sam-fg">
