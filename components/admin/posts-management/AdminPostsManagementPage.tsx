      ...
      {loading ? (
        ...
        <>
          ...
          {showBottomFixedScroll && (
            <div
              data-admin-posts-mgmt-bottom-hscroll="1"
              className="fixed bottom-0 left-0 right-0 z-20 border-t border-sam-border bg-sam-surface md:hidden px-3 pb-[var(--safe-bottom)]"
            >
              <div
                ref={bottomScrollRef}
