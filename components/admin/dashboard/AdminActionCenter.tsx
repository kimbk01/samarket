...
export function AdminActionCenter() {
  ...
  const actionCards: QueueCard[] = [
    ...
    {
      id: "store-apps",
      href: withAdminReturnTo("/admin/stores?status=actionable", returnTo),
      count: q.storeApplicationsCount,
      unavailable: unavailable.has("store_applications"),
      titleKo: "입점 검토",
      titleEn: "Store applications",
      domainKo: "매장",
      domainEn: "Store",
      primaryCtaKo: "입점 대기 목록",
      primaryCtaEn: "Actionable stores",
    },
    {
      id: "trade-promo",
  ...
  const domainHealth: QueueCard[] = [
    ...
    {
      id: "domain-chat",
      href: withAdminReturnTo("/admin/chats/reported", returnTo),
      count: q.messengerActionableCount,
      unavailable: unavailable.has("messenger_actionable"),
      titleKo: "채팅 (메신저)",
      titleEn: "Chat (Messenger)",
      domainKo: "채팅",
      domainEn: "Chat",
      primaryCtaKo: "신고 큐",
      primaryCtaEn: "Report queue",
      alwaysShow: true,
    },
  ];
