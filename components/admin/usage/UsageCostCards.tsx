      ...
      {latest ? (
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
          <div className="rounded-ui-rect border border-sam-border bg-sam-surface p-4">
            <p className="sam-text-helper text-sam-muted">DB 사용량</p>
          ...
          <div className="rounded-ui-rect border border-sam-border bg-sam-surface p-4">
            <p className="sam-text-helper text-sam-muted">API 요청 수</p>
            <p className="sam-text-page-title font-semibold text-sam-fg">
              {(latest.apiRequests / 1000).toFixed(0)}K
            </p>
          </div>
          <div className="rounded-ui-rect border border-sam-border bg-sam-surface p-4">
            <p className="sam-text-helper text-sam-muted">월간 비용 추정</p>
            <p className="sam-text-page-title font-semibold text-sam-fg">
        ...
        <p className="sam-text-body text-sam-muted">사용량 데이터 없음</p>
      )}
