    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
        <div className="rounded-ui-rect border border-sam-border bg-sam-surface p-4">
          <p className="text-[12px] text-sam-muted">체크리스트 완료율</p>
        ...
        <div className="rounded-ui-rect border border-sam-border bg-sam-surface p-4">
          <p className="text-[12px] text-sam-muted">미완료 액션아이템</p>
          <p className="text-[20px] font-semibold text-sam-fg">
        ...
        <div className="rounded-ui-rect border border-sam-border bg-sam-surface p-4">
          <p className="text-[12px] text-sam-muted">기한 초과</p>
          <p className={`text-[20px] font-semibold ${summary.overdueActions > 0 ? "text-red-600" : "text-sam-fg"}`}>
