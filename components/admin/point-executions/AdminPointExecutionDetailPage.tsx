      ...
      <AdminCard title="실행 정보">
        <dl className="grid grid-cols-1 gap-2 text-[14px] sm:grid-cols-2">
          <div>
            ...
            <dd className="font-medium text-gray-900">{execution.id}</dd>
          </div>
          <div>
            <dt className="text-gray-500">실행 키</dt>
            <dd className="truncate font-mono text-[13px] text-gray-700">
              {execution.executionKey}
            </dd>
          </div>
          <div>
            <dt className="text-gray-500">게시판</dt>
          ...
          <div>
            <dt className="text-gray-500">보상 유형</dt>
            <dd>{execution.rewardType === "fixed" ? "고정" : "확률형"}</dd>
          </div>
          <div>
            <dt className="text-gray-500">기본 P / 배율 / 최종 P</dt>
            <dd>
          ...
          {(execution.capped || execution.cooldownBlocked || execution.duplicateBlocked) && (
            <div className="sm:col-span-2">
              <dt className="text-gray-500">차단 사유</dt>
              <dd>
