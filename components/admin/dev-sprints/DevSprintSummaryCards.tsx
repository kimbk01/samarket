    ...
    <div className="space-y-4">
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        <div className="rounded-ui-rect border border-sam-border bg-sam-surface p-4">
          <p className="sam-text-helper text-sam-muted">스프린트 / 진행중</p>
          <p className="sam-text-page-title font-semibold text-sam-fg">
            {summary.totalSprints} / {summary.activeSprints}
          </p>
        </div>
        <div className="rounded-ui-rect border border-sam-border bg-sam-surface p-4">
          <p className="sam-text-helper text-sam-muted">작업 / 완료 / 블로킹</p>
        ...
        <div className="rounded-ui-rect border border-sam-border bg-sam-surface p-4">
          <p className="sam-text-helper text-sam-muted">velocity (placeholder)</p>
          <p className="sam-text-page-title font-semibold text-sam-fg">
            {summary.averageVelocity}
          </p>
        </div>
        <div className="rounded-ui-rect border border-sam-border bg-sam-surface p-4">
          <p className="sam-text-helper text-sam-muted">최신 릴리즈</p>
