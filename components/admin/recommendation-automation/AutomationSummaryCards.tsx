  ...
  return (
    <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
      <div className="rounded-ui-rect border border-sam-border bg-sam-surface p-4">
        <p className="sam-text-helper text-sam-muted">정책</p>
        <p className="sam-text-page-title font-semibold text-sam-fg">
          {summary.activePolicies} / {summary.totalPolicies}
        </p>
        <p className="sam-text-body-secondary text-sam-muted">활성 / 전체</p>
      </div>
      <div className="rounded-ui-rect border border-sam-border bg-sam-surface p-4">
        <p className="sam-text-helper text-sam-muted">Dry-run</p>
        <p className="sam-text-page-title font-semibold text-amber-600">
          {summary.dryRunPolicies}
        </p>
        <p className="sam-text-body-secondary text-sam-muted">정책</p>
      </div>
      <div className="rounded-ui-rect border border-sam-border bg-sam-surface p-4">
        <p className="sam-text-helper text-sam-muted">오늘 실행</p>
        <p className="sam-text-page-title font-semibold text-sam-fg">
      ...
      <div className="rounded-ui-rect border border-sam-border bg-sam-surface p-4">
        <p className="sam-text-helper text-sam-muted">Fallback / 킬스위치</p>
        <p className="sam-text-page-title font-semibold text-sam-fg">
          {summary.activeFallbackCount} / {summary.activeKillSwitchCount}
        </p>
        <p className="sam-text-body-secondary text-sam-muted">surface</p>
      </div>
      <div className="rounded-ui-rect border border-sam-border bg-sam-surface p-4">
        <p className="sam-text-helper text-sam-muted">최근 실행</p>
