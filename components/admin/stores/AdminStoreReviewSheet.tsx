...
function ReviewSection({
  ...
  return (
    <section className="rounded-xl border border-gray-100 bg-gray-50/60 p-3">
    ...
    <div className="fixed inset-0 z-[60] flex justify-end">
      ...
      >
        ...
        <div className="min-h-0 flex-1 space-y-4 overflow-y-auto px-4 py-4">
          <div className="rounded-xl border border-signature/20 bg-signature/5 px-3 py-3">
          ...
          {onSetOwnerIdentityEditable ?
            <div className="rounded-xl border border-gray-200 bg-white p-3">
              ...
              <button
                ...
                className="mt-3 rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-[13px] font-medium text-gray-900 disabled:opacity-50"
              >
                {identityActionBusy ?
                  "처리 중…"
