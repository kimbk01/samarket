          ...
          <table className="min-w-[1280px] w-full border-collapse text-left text-[13px]">
            <thead className="border-b border-gray-200 bg-gray-50 text-[12px] text-gray-600">
              <tr>
                ...
                <th className="min-w-[14rem] px-3 py-2 font-medium">액션</th>
              </tr>
            </thead>
            <tbody>
              {rows.map((r) => {
                      ...
                      <div className="flex min-w-0 flex-col gap-1.5">
                        {r.approval_status !== "approved" && (
                          <button
                            type="button"
                            disabled={disabled}
                            className="rounded border border-green-200 bg-green-50 px-2.5 py-1.5 text-left text-[12px] leading-snug text-green-900 disabled:opacity-50"
                        ...
                        r.approval_status === "revision_requested" ? (
                          <>
                            <button
                              type="button"
                              disabled={disabled}
                              className="rounded border border-amber-200 bg-amber-50 px-2.5 py-1.5 text-left text-[12px] leading-snug text-amber-900 disabled:opacity-50"
                              onClick={() => {
                            ...
                            <button
                              type="button"
                              disabled={disabled}
                              className="rounded border border-red-200 bg-red-50 px-2.5 py-1.5 text-left text-[12px] leading-snug text-red-900 disabled:opacity-50"
                              onClick={() => {
                        ...
                        {r.approval_status === "approved" && (
                          <>
                            <button
                              type="button"
                              disabled={disabled}
                              className="rounded border border-indigo-200 bg-indigo-50 px-2.5 py-1.5 text-left text-[12px] leading-snug text-indigo-900 disabled:opacity-50"
                              onClick={() =>
                                void runAction(r.id, {
                            ...
                            >
                              {r.owner_can_edit_store_identity ? "식별 수정 허용 해제" : "식별 수정 허용"}
                            </button>
                            <button
                              type="button"
                              disabled={disabled}
                              className="rounded border border-gray-200 bg-gray-50 px-2.5 py-1.5 text-left text-[12px] leading-snug text-gray-800 disabled:opacity-50"
                              onClick={() => {
                            ...
                            {sp?.sales_status !== "approved" && (
                              <>
                                <button
                                  type="button"
                                  disabled={disabled}
                                  className="rounded border border-blue-200 bg-blue-50 px-2.5 py-1.5 text-left text-[12px] leading-snug text-blue-900 disabled:opacity-50"
                                ...
                                <button
                                  type="button"
                                  disabled={disabled}
                                  className="rounded border border-red-100 bg-white px-2.5 py-1.5 text-left text-[12px] leading-snug text-red-800 disabled:opacity-50"
                                  onClick={() => {
                            ...
                            {sp?.sales_status === "approved" && (
                              <button
                                type="button"
                                disabled={disabled}
                                className="rounded border border-orange-200 bg-orange-50 px-2.5 py-1.5 text-left text-[12px] leading-snug text-orange-900 disabled:opacity-50"
                                onClick={() => {
                        ...
                        {r.approval_status === "suspended" && (
                          <button
                            type="button"
                            disabled={disabled}
                            className="rounded border border-gray-200 bg-white px-2.5 py-1.5 text-left text-[12px] leading-snug text-gray-800 disabled:opacity-50"
