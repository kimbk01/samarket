  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-wrap items-center gap-2">
        <span className="text-[13px] text-gray-600">스냅샷 (완료된 것만)</span>
        <select
        ...
        <button
          ...
          className="rounded border border-gray-200 bg-gray-50 px-3 py-1.5 text-[13px] text-gray-700 hover:bg-gray-100 disabled:opacity-50"
        >
          복구 시뮬레이션
        </button>
      </div>
        ...
        {restores.length === 0 ? (
          ...
          <ul className="mt-2 space-y-2">
            {restores.slice(0, 5).map((r) => (
              <li key={r.id} className="text-[13px] text-gray-600">
