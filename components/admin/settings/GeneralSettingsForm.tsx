    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        <input
          ...
          className="mt-2 block w-full max-w-xs text-[13px] text-gray-600 file:mr-2 file:rounded file:border-0 file:bg-signature file:px-3 file:py-1.5 file:text-[13px] file:text-white file:hover:opacity-90"
        />
        {values.alarmSoundDataUrl ? (
          <p className="mt-2 text-[12px] text-green-600">알람 사운드가 설정되어 있습니다.</p>
        ) : (
          <p className="mt-2 text-[12px] text-gray-500">알람 사운드가 없습니다. MP3 파일을 선택해 주세요.</p>
        )}
      </div>
    </div>
  );
