  ...
  return (
    <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
      <div className="rounded-ui-rect border border-sam-border bg-sam-surface p-4">
        <p className="text-[12px] text-sam-muted">벤치마크 요약</p>
      ...
      <div className="rounded-ui-rect border border-sam-border bg-sam-surface p-4">
        <p className="text-[12px] text-sam-muted">분기 계획 요약</p>
        <p className="text-[20px] font-semibold text-sam-fg">
      ...
      <div className="rounded-ui-rect border border-sam-border bg-sam-surface p-4">
        <p className="text-[12px] text-sam-muted">성과 리뷰 요약</p>
        <p className="text-[20px] font-semibold text-sam-fg">
      ...
      <div className="rounded-ui-rect border border-sam-border bg-sam-surface p-4 sm:col-span-2 lg:col-span-3">
        <p className="text-[12px] text-sam-muted">바로가기</p>
        <p className="mt-1 text-[14px] text-sam-fg">
