...
export const SELLER_LISTING_CONTROL_BOX_LAYOUT =
  "relative box-border inline-flex h-[31px] min-h-[31px] w-max max-w-none shrink-0 items-center rounded-ui-rect px-1.5 sam-text-xxs font-bold leading-none shadow-sm";
