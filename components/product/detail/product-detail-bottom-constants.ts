...
export const PRODUCT_DETAIL_BOTTOM_BAR = `fixed bottom-0 left-1/2 z-30 flex h-14 min-h-[52px] max-h-[60px] w-full ${APP_MAIN_COLUMN_MAX_WIDTH_CLASS} -translate-x-1/2 items-center gap-2 border-t border-gray-200 bg-white px-3 sm:px-4 md:px-5 safe-area-pb`;
