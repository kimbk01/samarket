    ...
    <section className="border-b border-gray-100 bg-white px-4 py-4">
      ...
      <div className="flex gap-2 overflow-x-auto pb-1">
        {value.map((item, index) => (
          <div key={index} className="relative h-24 w-24 shrink-0 overflow-hidden rounded-lg bg-gray-100">
        ...
        {value.length < maxCount && (
          <button
            ...
            className="flex h-24 w-24 shrink-0 items-center justify-center rounded-lg border-2 border-dashed border-gray-300 text-gray-400"
          >
            +
          </button>
        )}
