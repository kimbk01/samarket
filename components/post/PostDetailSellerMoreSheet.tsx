      ...
      >
        ...
        <div className="rounded-xl border border-gray-100 bg-gray-50 p-2">
          <button
            ...
            className="flex w-full items-center justify-center rounded-lg bg-red-600 px-3 py-3 text-[15px] font-semibold text-white hover:bg-red-700 disabled:opacity-50"
          >
            {busy ? "처리 중…" : "물품 판매 취소"}
          </button>
          <button
            type="button"
            onClick={onClose}
            className="mt-2 w-full rounded-lg border border-gray-200 bg-white py-2.5 text-[14px] font-medium text-gray-700 hover:bg-gray-50"
          >
            닫기
          </button>
        </div>
