...
```yaml
- generic [ref=e3]:
  - heading "Sign in to dibaY" [level=1] [ref=e4]
  - paragraph [ref=e5]: Available sign-in methods depend on admin settings.
  - paragraph [ref=e7]: Loading social sign-in settings…
  - generic [ref=e10]: Or ID / password
  - generic [ref=e12]:
    - group [ref=e13]:
      - generic [ref=e14]:
        - generic [ref=e15]: Email or Login ID
        - textbox "Email or Login ID" [ref=e16]
      - generic [ref=e17]:
