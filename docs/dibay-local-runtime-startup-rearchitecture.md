...
| 날짜 | 항목 | 결과 |
|------|------|------|
| 2026-07-27 | Hybrid WIP → `archive/startup-hybrid-handoff-wip` | preserved |
| 2026-07-27 | Epic 정정 + 본 문서 | IN PROGRESS |
| — | Local Runtime core | pending |
| — | Android / iOS integration | pending |
| — | Cutover / QA | pending |
