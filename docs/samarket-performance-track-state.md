...
| 필드 | 값 |
|------|-----|
| Last updated | 2026-05-25 (LFC1-B Phase B hard delete **4/4 PASS**) |
| Owner | (선택) |
...
| 트랙 이름 | **LFC1-C** Phase C messenger routes (HS2 · CR1 · CMB1 · FBT1 · RB1 · HUB BADGE) |
| **트랙 상태** | **▲ 대기** — LFC1-B PASS 후 재개 |
| PASS 게이트 | per-route soft-disable verify → hard delete → RPC/E2E/tsc · reconnect stress for reconnect_related routes |
