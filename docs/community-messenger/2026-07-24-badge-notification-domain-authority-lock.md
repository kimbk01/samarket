...
| Surface | Rule |
|---------|------|
| Header Bell | `badge-count.total` = Domain projection only · event SUM 금지 · adminNotice supplement 재가산 금지 |
| App Icon | Domain App Icon projection · **Bell mirror 금지** |
| Bottom Chat | **general_direct + group unread 방 수만** · trade/SO 제외 |
...
- Residual review — 삭제 대상 0 · 전부 삭제 금지로 분류 (`2026-07-24-badge-bell-phase-j-residual-review.md`)
- **Phase J LOCK — 보류** (2기기 QA + 명시 승인)

**실삭제·공식 변경은 슬라이스별 승인 전 금지.**
