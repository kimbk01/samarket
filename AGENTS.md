...
- 체감 성능 운영 헌장·트랙/미완 상태: `docs/samarket-native-feel-charter.md`, `docs/samarket-performance-track-state.md` (Cursor: `.cursor/rules/samarket-performance-continuity.mdc`). 도메인별 완료율(체감만, UI 별도): `docs/samarket-perf-domain-checksheet.md`.
