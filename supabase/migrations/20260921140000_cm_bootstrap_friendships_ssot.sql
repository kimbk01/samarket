-- get_cm_bootstrap_full_snapshot — social graph from community_messenger_friendships SSOT
...
COMMENT ON FUNCTION public.get_cm_bootstrap_full_snapshot(uuid, text, integer, text) IS
  'FBT1 CM bootstrap — community_messenger_friendships SSOT for friends/requests/blocked.';
