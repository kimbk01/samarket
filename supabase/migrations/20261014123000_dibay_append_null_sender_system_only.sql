-- Room Unread v1.1 harden: NULL message sender only for message_type = system
...
COMMENT ON FUNCTION public.dibay_append_room_message_atomic(
  ...
  'Room Unread v1.1h: NULL sender only when message_type=system; otherwise null_sender_forbidden.';
