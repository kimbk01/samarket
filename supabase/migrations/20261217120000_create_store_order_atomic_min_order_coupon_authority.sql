-- CUT FINAL — below_min_order + coupon discount_amount DB authority
-- Preserves ROOT A money authority, gift live-compat (gift_certificate_products.platform_fee_rate),
-- idempotency, atomicity. No gift fee-snapshot helper dependency.
