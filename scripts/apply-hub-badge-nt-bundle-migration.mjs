#!/usr/bin/env node
/** Apply supabase/migrations/20260608120000_hub_badge_notification_target_bundle_columns.sql */
...
async function main() {
  ...
  const sql = readFileSync(
    resolve(
      process.cwd(),
      "supabase/migrations/20260608120000_hub_badge_notification_target_bundle_columns.sql"
    ),
    "utf8"
  );
  ...
  await client.end();
  console.log("[apply-hub-badge-nt-bundle-migration] ok");
}
