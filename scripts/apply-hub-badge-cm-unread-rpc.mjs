#!/usr/bin/env node
/** Apply supabase/migrations/20260521120000_get_community_messenger_unread_room_count_rpc.sql */
...
async function main() {
  ...
  const sql = readFileSync(
    resolve(
      process.cwd(),
      "supabase/migrations/20260521120000_get_community_messenger_unread_room_count_rpc.sql"
    ),
    "utf8"
  );
  ...
  await client.end();
  console.log("[apply-hub-badge-cm-unread-rpc] ok");
}
