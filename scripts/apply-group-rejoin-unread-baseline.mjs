#!/usr/bin/env node
/**
 * Apply 20261014124000_dibay_group_rejoin_unread_baseline.sql
...
async function main() {
  ...
  const sql = readFileSync(
    resolve(process.cwd(), "supabase/migrations/20261014124000_dibay_group_rejoin_unread_baseline.sql"),
    "utf8"
  );
  ...
  await client.end();
  console.log("[apply-group-rejoin-unread-baseline] ok");
}
