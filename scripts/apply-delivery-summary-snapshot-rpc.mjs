#!/usr/bin/env node
/** Apply supabase/migrations/20260525230000_delivery_summary_snapshot.sql */
...
async function main() {
  ...
  const sql = readFileSync(
    resolve(process.cwd(), "supabase/migrations/20260525230000_delivery_summary_snapshot.sql"),
    "utf8"
  );
  ...
  await client.end();
  console.log("[apply-delivery-summary-snapshot-rpc] ok");
}
