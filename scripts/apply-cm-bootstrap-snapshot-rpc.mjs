#!/usr/bin/env node
/** Apply supabase/migrations/20260526100000_cm_bootstrap_critical_snapshot.sql */
...
async function main() {
  ...
  const sql = readFileSync(
    resolve(process.cwd(), "supabase/migrations/20260526100000_cm_bootstrap_critical_snapshot.sql"),
    "utf8"
  );
  ...
  await client.end();
  console.log("[apply-cm-bootstrap-snapshot-rpc] ok");
}
