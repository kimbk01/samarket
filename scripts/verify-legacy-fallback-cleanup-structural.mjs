...
mustInclude("lib/stores/fetch-stores-browse-legacy.ts", "gateLegacyFallback");
mustInclude("lib/stores/fetch-buyer-store-orders-list-legacy.ts", "gateLegacyFallback");
