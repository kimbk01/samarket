#!/usr/bin/env node
/** Apply supabase/migrations/20270324120000_commerce_notification_push_handoff.sql */
...
async function main() {
  ...
  const sql = readFileSync(
    resolve(process.cwd(), "supabase/migrations/20270324120000_commerce_notification_push_handoff.sql"),
    "utf8"
  );
  ...
  await client.end();
  console.log("[apply-commerce-notification-push-handoff-migration] ok");
}
