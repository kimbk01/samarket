#!/usr/bin/env node
/** Apply supabase/migrations/20260522120000_hub_badge_user_unread_counters.sql */
...
async function main() {
  ...
  const sql = readFileSync(
    resolve(process.cwd(), "supabase/migrations/20260522120000_hub_badge_user_unread_counters.sql"),
    "utf8"
  );
  ...
  await client.end();
  console.log("[apply-hub-badge-unread-counter-table] ok");
}
