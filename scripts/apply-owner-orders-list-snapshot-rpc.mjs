#!/usr/bin/env node
/** Apply supabase/migrations/20260526000000_owner_store_orders_list_snapshot.sql */
...
async function main() {
  ...
  const sql = readFileSync(
    resolve(process.cwd(), "supabase/migrations/20260526000000_owner_store_orders_list_snapshot.sql"),
    "utf8"
  );
  ...
  await client.end();
  console.log("[apply-owner-orders-list-snapshot-rpc] ok");
}
