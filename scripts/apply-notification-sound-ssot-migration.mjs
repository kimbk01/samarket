#!/usr/bin/env node
/** Apply supabase/migrations/20260930120000_notification_sound_ssot.sql */
...
async function main() {
  ...
  const sql = readFileSync(
    resolve(process.cwd(), "supabase/migrations/20260930120000_notification_sound_ssot.sql"),
    "utf8"
  );
  ...
  await client.end();
  console.log("[apply-notification-sound-ssot-migration] ok");
}
