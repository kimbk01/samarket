#!/usr/bin/env node
/** Apply supabase/migrations/20260519120000_hub_badge_user_chat_unread_parts_rpc.sql */
...
async function main() {
  ...
  const sql = readFileSync(
    resolve(process.cwd(), "supabase/migrations/20260519120000_hub_badge_user_chat_unread_parts_rpc.sql"),
    "utf8"
  );
  ...
  await client.end();
  console.log("[apply-hub-badge-unread-rpc] ok");
}
