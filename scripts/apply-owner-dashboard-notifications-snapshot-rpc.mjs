#!/usr/bin/env node
/** Apply supabase/migrations/20260525220000_owner_dashboard_notifications_snapshot.sql */
...
async function main() {
  ...
  const sql = readFileSync(
    resolve(
      process.cwd(),
      "supabase/migrations/20260525220000_owner_dashboard_notifications_snapshot.sql"
    ),
    "utf8"
  );
  ...
  await client.end();
  console.log("[apply-owner-dashboard-notifications-snapshot-rpc] ok");
}
