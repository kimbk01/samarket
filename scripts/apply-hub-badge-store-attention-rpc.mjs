#!/usr/bin/env node
/** Apply supabase/migrations/20260520120000_get_owner_hub_store_attention_counts_rpc.sql */
...
async function main() {
  ...
  const sql = readFileSync(
    resolve(
      process.cwd(),
      "supabase/migrations/20260520120000_get_owner_hub_store_attention_counts_rpc.sql"
    ),
    "utf8"
  );
  ...
  await client.end();
  console.log("[apply-hub-badge-store-attention-rpc] ok");
}
