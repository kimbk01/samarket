#!/usr/bin/env node
/** Apply supabase/migrations/20260525180000_owner_hub_badge_snapshot_rpc.sql */
...
async function main() {
  ...
  const sql = readFileSync(
    resolve(process.cwd(), "supabase/migrations/20260525180000_owner_hub_badge_snapshot_rpc.sql"),
    "utf8"
  );
  ...
  await client.end();
  console.log("[apply-owner-hub-badge-snapshot-rpc] ok");
}
