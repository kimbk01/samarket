...
} from "@/lib/posts/philife-posts-route-core";
...
export async function GET(req: NextRequest) {
  ...
  const homeDiag =
    req.nextUrl.searchParams.get("philife_diag") === "1" ||
    req.nextUrl.searchParams.get("home_diag") === "1";
...
export { POST } from "../../community/posts/route";
