...
import { joinCommunityChatRoom } from "@/lib/community-meeting-open-chat/rooms-service";
...
export async function POST(req: NextRequest, ctx: Ctx) {
  ...
  const result = await joinCommunityChatRoom(sb, {
    meetingId: mid,
    roomId: rid,
    userId: auth.userId,
    nickname,
    avatarUrl: typeof body.avatarUrl === "string" ? body.avatarUrl : null,
    passwordPlain: typeof body.password === "string" ? body.password : null,
    requestMessage: typeof body.requestMessage === "string" ? body.requestMessage : null,
  });
