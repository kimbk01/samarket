  ...
  return (
    <div className={`min-h-[50vh] bg-sam-app pb-10 dark:bg-[#18191A] ${APP_MAIN_GUTTER_X_CLASS} pt-2 sm:pt-3`}>
      <div
        ...
        aria-hidden
      />
      <div className="rounded-ui-rect bg-sam-surface px-4 py-12 text-center sam-text-body text-[#65676B] shadow-[0_1px_2px_rgba(0,0,0,0.06)] ring-1 ring-black/[0.06] dark:bg-[#242526] dark:text-[#B0B3B8] dark:ring-sam-surface/[0.08]">
        <RouteLoadingInline />
      </div>
    </div>
  );
