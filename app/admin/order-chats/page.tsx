        ...
        <section className="rounded-ui-rect border border-sam-border bg-sam-surface p-4">
          ...
          <ul className="mt-2 space-y-2 text-[13px] text-sam-fg">
            <li>
              ...
              <code className="rounded bg-sam-app px-1 text-[11px]">?order_id=UUID</code>
            </li>
            <li>
            ...
            <li>
              ...
              <code className="rounded bg-sam-app px-1 text-[11px]">
        ...
        <section className="rounded-ui-rect border border-sam-border bg-sam-surface p-4">
          ...
          <ul className="mt-2 space-y-2 text-[13px] text-sam-fg">
            ...
            <li>
              ...
              <code className="rounded bg-sam-app px-1 text-[11px]">?room=UUID</code>
              <span className="text-sam-muted"> 또는 </span>
              <code className="rounded bg-sam-app px-1 text-[11px]">?q=키워드</code>
            </li>
            <li>
