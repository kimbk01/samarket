  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <header className="sticky top-0 z-10 flex items-center border-b border-gray-100 bg-white px-4 py-3">
        ...
        <h1 className="flex-1 text-center text-[16px] font-semibold text-gray-900">후기 관리</h1>
        <span className="w-11 shrink-0" />
      </header>
      <div className="mx-auto max-w-lg space-y-4 px-4 py-6">
        <p className="text-[14px] leading-relaxed text-gray-600">
          <strong className="text-gray-900">내가 남긴 거래 후기</strong>는 아래에서 확인할 수 있어요. 새 후기는{" "}
          <Link href="/mypage/purchases" className="font-medium text-violet-700 underline">
            구매내역
          </Link>
          ...
          <ul className="space-y-2">
            <li>
              <Link
                ...
                className="block rounded-lg border border-gray-100 bg-gray-50 px-3 py-2.5 text-[14px] font-medium text-violet-800"
              >
                구매내역
              </Link>
            </li>
