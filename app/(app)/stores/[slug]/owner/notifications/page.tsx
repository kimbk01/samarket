  ...
  if (!storeId) {
    return (
      <div className="min-h-screen bg-[#f3f4f6] px-4 py-16 text-center text-sm text-gray-700">
        시뮬 알림은 <span className="font-mono">seoul-korean-house</span> 매장에서 확인할 수 있어요.
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-[#f3f4f6] pb-10">
      <header className="sticky top-0 z-10 border-b border-gray-200 bg-white px-2 py-2">
        <div className="mx-auto flex max-w-3xl items-center gap-2">
          <AppBackButton backHref="/my/business/store-orders" />
      ...
      <div className="mx-auto max-w-3xl space-y-4 px-3 pt-4">
        ...
        <Link href="/my/business/store-orders" className="text-sm text-violet-700 underline">
          주문 관리로
        </Link>
      </div>
    </div>
